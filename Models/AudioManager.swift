...
class AudioManager: NSObject, ObservableObject, AVAudioPlayerDelegate {
    ...
    // Used by the Owl Guide to know when narration
    ...
    func play(
        ...
        do {
            ...
            // Reset completion state whenever new audio starts.
    ...
    private func loadWordTimings(
        ...
        do {
            ...
            print(
                "Loaded \(wordTimings.count) timings"
            )
                ...
                for (index, timing)
                    ...
                    if currentTime >= timing.start &&
                        ...
                        if currentWordIndex != index {
                            ...
                            print(
                                "Highlighting word \(index): \(timing.word)"
                            )
    ...
    func audioPlayerDidFinishPlaying(
        ...
        DispatchQueue.main.async {
            ...
            // Tell the Owl Guide that narration
            // has completely finished.
