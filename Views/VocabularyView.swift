...
struct VocabularyView: View {
    ...
    var body: some View {
                    ...
                    if !words.isEmpty {
                        ...
                        HStack(
                            ...
                            Button {
                                ...
                                if owlGuide.currentStep == .vocabularySwipe {
                                    owlGuide.nextStep()
                                }
                            ...
                            .owlGuideTarget("vocabularySwipe")
                        }
                ...
                if showReward {
                    ...
                    VStack {
                        ...
                        HStack(spacing: 0) {
                            ...
                            Text(
                                "Wow! You learned new words today!"
                            )
                            .font(
                                .custom(
                                    "OpenDyslexic-Bold",
        ...
        // MARK: Start Vocabulary Guide

        .onAppear {

            if owlGuide.currentStep == .newWords {
                owlGuide.currentStep = .vocabularyAudio
            }
        }
...
//            }
//
//            if owlGuide.currentStep == .vocabularyAudio {
//                owlGuide.nextStep()
//            }
//        }
    }
        ...
        VStack(
            ...
            HStack {
                ...
                Button {
                    ...
                    // Move from audio guide
                    // to bookmark guide immediately.
                ...
                Button {
                    ...
                    if owlGuide.currentStep == .vocabularyBookmark {
                        owlGuide.nextStep()
                    }
            ...
            Divider()
                .overlay(
                    Color.appPrimaryText.opacity(0.18)
                )
                .padding(.top, 4)
