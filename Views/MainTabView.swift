...
struct PremiumTabBar: View {
    ...
    @ObservedObject var progress =
        ProgressManager.shared

    @ObservedObject var owlGuide =
        ...
        Button {
            ...
            withAnimation(
                ...
                if tab == .badges {
                    ...
                    if owlGuide.currentStep == .achievements {
                        owlGuide.finishGuide()
                    }
                }
            }
            ...
            ZStack {
                ...
                ZStack {
                    ...
                    if tab == .badges &&
                        progress.hasUnseenAchievements {

                        Circle()

                            .fill(
                                Color.red.opacity(0.19)
                            )
                ...
                .onChange(
                    of: progress.hasUnseenAchievements
                ) { _ in
...
struct GameHubView: View {
    ...
    @StateObject private var progress =
        ProgressManager.shared
            ...
            if let story = lockedStory {
                ...
                ZStack {
                    ...
                    VStack(spacing: 16) {
                        ...
                        Text(
                            "Finish reading this story to unlock the game"
                        )
